// src/auth.js -- Auth.js v5 (next-auth@5) stub.
//
// Lives in src/ so the @/ path alias (which maps to src/) resolves correctly.
// Root-level auth.js is kept for reference but this file is what the codebase
// imports via @/auth.
//
